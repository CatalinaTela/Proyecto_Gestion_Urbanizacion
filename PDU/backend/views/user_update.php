...
<div class="container pb-6 pt-6">
	...
	<form action="./backend/php/usuario_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<input type="hidden" name="id_user" value="<?php echo $datos['id_user']; ?>" required >
		  	...
		  	<div class="column">
		    	...
		    	<div class="control">
					<label>Telefono</label>
				  	<input class="input" type="text" name="usuario_telefono" pattern="\+?[1-9][0-9]{1,3}[0-9 ]{6,12}" maxlength="15" required value="<?php echo $datos['phone']; ?>" >
				</div>
		  	</div>
		</div>
		<br><br>
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Email</label>
				  	<input class="input" type="text" name="administrador_email"  maxlength="70" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
