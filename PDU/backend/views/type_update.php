...
<div class="container pb-6 pt-6">
	...
	<form action="./backend/php/tipos_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<input type="hidden" name="id_type" value="<?php echo $datos['id_type']; ?>" required >

		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Nombre</label>
				  	<input class="input" type="text" name="type_name" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{4,50}" maxlength="50" required value="<?php echo $datos['type_name']; ?>" >
				</div>
		  	</div>
		</div>
