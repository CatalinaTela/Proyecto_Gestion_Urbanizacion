...
<div class="container pb-6 pt-6">
	...
	<form action="./backend/php/operaciones_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<input type="hidden" name="id_operation" value="<?php echo $datos['id_operation']; ?>" required >

		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Nombre</label>
				  	<input class="input" type="text" name="operation_name" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{4,50}" maxlength="50" required value="<?php echo $datos['operation_name']; ?>" >
				</div>
		  	</div>
		</div>
